...
cronicle.compile = function (schedDef) {
  ...
  return {
    ...
    /**
     * Calculates the start of the next valid occurrence of a particular recurrence
 ...
 */
cronicle.recurrence = function (sched) {
  ...
  for (var i = 0; i < recurrencesLen; i++) {
    recurrences.push(cronicle.compile(sched.recurrences[i]))
  }
  ...
  return {
    ...
    /**
     * Returns true if d is a valid occurrence of the current recurrence.
     *
